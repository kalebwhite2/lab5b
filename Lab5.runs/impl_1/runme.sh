...
HD_PWD='/home/kalebw02/VivadoLabs/Lab5/Lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log io_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source io_demo.tcl -notrace
